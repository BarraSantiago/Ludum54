...
public class ScreenShake : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        AnimationCurve linearCurve = new AnimationCurve(new Keyframe(0, 0), new Keyframe(1, 1));

        gm.OnDestroyNormalTower += () => StartCoroutine(Shake(0.3f, linearCurve));
        gm.OnDestroyMainTower += () => StartCoroutine(Shake(0.5f, linearCurve));
    }
